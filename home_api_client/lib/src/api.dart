...
import 'package:home_api_client/src/serializers.dart';
import 'package:home_api_client/src/auth/api_key_auth.dart';
import 'package:home_api_client/src/auth/basic_auth.dart';
import 'package:home_api_client/src/auth/bearer_auth.dart';
...
class HomeApiClient {
  ...
  LightingApi getLightingApi() {
    return LightingApi(dio, serializers);
  }
