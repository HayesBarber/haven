...
class DiscoveryApi {
  ...
  Future<Response<CheckinResponse>> checkInDeviceDiscoveryCheckInPost({ 
    ...
    final _path = r'/discovery/check-in';
  ...
  Future<Response<DeviceDiscoveryResponse>> discoverEspDiscoveryDiscoverEspPost({ 
    ...
    final _path = r'/discovery/discover/esp';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [DeviceDiscoveryResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<DeviceDiscoveryResponse>> discoverKasaDiscoveryDiscoverKasaPost({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/discovery/discover/kasa';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [DeviceDiscoveryResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<DeviceDiscoveryResponse>> discoverLifxDiscoveryDiscoverLifxPost({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/discovery/discover/lifx';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
