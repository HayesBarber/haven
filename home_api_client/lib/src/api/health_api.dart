...
class HealthApi {
  ...
  Future<Response<HealthResponse>> getHealthHealthPost({ 
    required HealthRequest healthRequest,
    ...
    try {
      const _type = FullType(HealthRequest);
      _bodyData = _serializers.serialize(healthRequest, specifiedType: _type);
